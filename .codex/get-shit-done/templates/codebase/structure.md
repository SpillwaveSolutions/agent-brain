...
- Usage: Reference from command with `@/Users/richardhightower/clients/spillwave/src/agent-brain/.codex/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/richardhightower/clients/spillwave/src/agent-brain/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/richardhightower/clients/spillwave/src/agent-brain/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
