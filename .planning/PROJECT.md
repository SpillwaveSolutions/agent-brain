...
- [x] **FRAME-01..05**: Python framework adapter smoke tests (OpenAI Agents stdio+http, LangChain, LlamaIndex, Pydantic AI, Autogen) — ✓ Validated in Phase 61
- [x] **FRAME-06..07**: TypeScript framework adapter smoke tests (Mastra `@mastra/mcp`, Vercel AI SDK `@ai-sdk/mcp`) — ✓ Validated in Phase 62
- [x] **MCPHYG-01..02**: MCP stdio subprocess hygiene + 1000-invocation orphan test — ✓ Validated in Phase 60
- [x] **TOOLING-V3-01**: `task mcp:framework-matrix` opt-in gated runner — ✓ Validated in Phase 63
- [x] **TOOLING-V3-02**: nightly advisory `framework-matrix.yml` CI (schedule+dispatch only, never blocks PRs) — ✓ Validated in Phase 63
- [x] **DOCS-V3-01**: `docs/INTEGRATIONS.md` framework guide (7 framework pages + 5 editor config recipes) — ✓ Validated in Phase 63
