...
- [ ] **FRAME-01**: OpenAI Agents SDK adapter smoke test — `MCPServerStdio` + `MCPServerStreamableHttp` connect to `agent-brain-mcp`, call `search_documents`, assert non-empty results.
