...
- ✅ **v9.2.0 Documentation Accuracy Audit** — Phases 29-33 + gap closure phases 36-37 and 40 (completed 2026-03-20)
...
- [x] **Phase 40: Active Doc Path Consistency & Flow Closure** — Close v9.2.0 audit gaps for CFGDOC-01, GUIDE-02, GUIDE-03, GUIDE-05 by normalizing `.agent-brain/` paths and reconciling setup and architecture docs (completed 2026-03-20)
...
### Phase 40: Active Doc Path Consistency & Flow Closure

**Goal:** Resolve remaining v9.2.0 audit blockers by standardizing active documentation on `.agent-brain/`, reconciling setup/architecture flow guidance, and re-verifying the four unsatisfied requirements.
**Depends on:** Phase 39
**Requirements:** CFGDOC-01, GUIDE-02, GUIDE-03, GUIDE-05
**Gap Closure:** Closes gaps from v9.2.0 audit
**Success Criteria** (what must be TRUE):
  1. No stale `.claude/agent-brain/` references remain in active docs included in developer and user setup flows (CONFIGURATION, QUICK_START, PLUGIN_GUIDE, DEVELOPERS_GUIDE, ARCHITECTURE, SETUP_PLAYGROUND)
  2. `docs/CONFIGURATION.md` config.json examples and path guidance match current CLI init behavior and state layout
  3. Setup and architecture docs present a consistent end-to-end flow with `.agent-brain/` state-dir usage and no contradictory path guidance
  4. New verification evidence demonstrates closure for CFGDOC-01, GUIDE-02, GUIDE-03, and GUIDE-05
**Plans:** 2/2 plans complete

Plans:
- [x] 40-01-PLAN.md — Sweep active docs for stale `.claude/agent-brain/` path usage and normalize to `.agent-brain/` (completed 2026-03-20)
- [x] 40-02-PLAN.md — Reconcile setup and architecture flow guidance and produce verification evidence for CFGDOC-01/GUIDE-02/GUIDE-03/GUIDE-05 (completed 2026-03-20)
